...
class _BuildFormState extends State<_BuildForm> {
  ...
  void _validateAndSubmit() {
    ...
    if (selectedKelompok.isEmpty || selectedDesa.isEmpty) {
      ...
      String errorMessage = '';
      if (selectedKelompok.isEmpty && selectedDesa.isEmpty) {
        errorMessage = 'Silakan pilih Kelompok Binaan dan Desa Binaan terlebih dahulu';
  ...
  void _collectAndLogData() {
    ...
    print('kecamatan: ${_getNamaKecamatan(wilayahState?.selectedKecamatanId)}'); // You'll need to implement this
    print('desaId: ${wilayahState?.selectedDesaId}');
    print('desa: ${_getNamaDesa(wilayahState?.selectedDesaId)}'); // You'll need to implement this
    print('kecamatanBinaan: ${_getNamaKecamatan(wilayahBinaanBloc.state.selectedKecamatanId)}'); // You'll need to implement this
    print('desaBinaan: ${_getNamaDesaList(wilayahBinaanBloc.state.selectedDesaIds)}'); // You'll need to implement this
    print('selectedKelompokIds: ${wilayahBinaanBloc.state.selectedKelompokIds.join(',')}');
