...
part of 'product_petani_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProductPetaniResponseModel _$ProductPetaniResponseModelFromJson(
...
Map<String, dynamic> _$ProductPetaniResponseModelToJson(
  ProductPetaniResponseModel instance,
) => <String, dynamic>{
...
Datum _$DatumFromJson(Map<String, dynamic> json) => Datum(
  ...
  profesiPenjual: $enumDecodeNullable(
    _$ProfesiPenjualEnumMap,
    json['profesiPenjual'],
  ),
  namaProducts: json['namaProducts'] as String?,
  stok: (json['stok'] as num?)?.toInt(),
  satuan: $enumDecodeNullable(_$SatuanEnumMap, json['satuan']),
...
Map<String, dynamic> _$DatumToJson(Datum instance) => <String, dynamic>{
  'id': instance.id,
  'profesiPenjual': _$ProfesiPenjualEnumMap[instance.profesiPenjual],
  'namaProducts': instance.namaProducts,
  'stok': instance.stok,
  'satuan': _$SatuanEnumMap[instance.satuan],
...
const _$ProfesiPenjualEnumMap = {
  ProfesiPenjual.PENYULUH: 'penyuluh',
  ProfesiPenjual.PETANI: 'petani',
};

const _$SatuanEnumMap = {Satuan.KG: 'kg', Satuan.PCS: 'Pcs'};

const _$StatusEnumMap = {
  Status.READY_STOCK: 'Ready stock',
  Status.READY_STOK: 'Ready stok',
...
TblAkun _$TblAkunFromJson(Map<String, dynamic> json) => TblAkun(
  ...
  peran: $enumDecodeNullable(_$ProfesiPenjualEnumMap, json['peran']),
...
Map<String, dynamic> _$TblAkunToJson(TblAkun instance) => <String, dynamic>{
  ...
  'peran': _$ProfesiPenjualEnumMap[instance.peran],
  'foto': instance.foto,
  'accountID': instance.accountId,
